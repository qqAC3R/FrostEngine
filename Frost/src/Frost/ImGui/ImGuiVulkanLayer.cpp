...
namespace Frost
{
	...
	void VulkanImGuiLayer::Set_FrostStyle_Theme()
	{
		...
		colors[ImGuiCol_WindowBg] = ImVec4(0.12f, 0.14f, 0.17f, 1.00f);// 13, 17, 31
		...
		colors[ImGuiCol_ResizeGrip] =        ImVec4(0.22f, 0.24f, 0.27f, 1.0f); //colors[ImGuiCol_ResizeGrip] = ImVec4(0.28f, 0.28f, 0.28f, 0.29f);
		colors[ImGuiCol_ResizeGripHovered] = ImVec4(0.24f, 0.28f, 0.31f, 0.29f);
		colors[ImGuiCol_ResizeGripActive] =   ImVec4(0.27f, 0.30f, 0.35f, 1.00f);

		colors[ImGuiCol_Tab] =                ImVec4(0.14f, 0.14f, 0.14f, 0.52f);
		colors[ImGuiCol_TabHovered] =         ImVec4(0.19f, 0.19f, 0.19f, 0.52f);
		colors[ImGuiCol_TabActive] =          ImVec4(0.20f, 0.20f, 0.20f, 0.52f);
		colors[ImGuiCol_TabUnfocused] =       ImVec4(0.14f, 0.14f, 0.14f, 0.52f);
		colors[ImGuiCol_TabUnfocusedActive] = ImVec4(0.14f, 0.14f, 0.14f, 0.52f);
		...
		colors[ImGuiCol_TableHeaderBg] = ImVec4(0.00f, 0.00f, 0.00f, 0.52f); // Tables (Name/ Tyoe entity)
	...
	void VulkanImGuiLayer::ResetStyleSettings()
	{
		...
		style.FrameBorderSize = 1; // This is for buttons
