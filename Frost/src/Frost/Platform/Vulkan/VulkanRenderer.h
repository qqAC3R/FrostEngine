...
namespace Frost
{
	...
	public:
		...
		virtual void SubmitText(const std::string& string, const Ref<Font>& font, const glm::mat4& transform, float maxWidth, float lineHeightOffset, float kerningOffset, const glm::vec4& color) override;
