...
shared float sharedClosestDeviceZ[64];
...
void main()
{
    ...
    ivec2 dispatchThreadId = ivec2(8 * gl_WorkGroupID) + groupThreadId;
    ...
    if(u_IsFirstPass)
        ...
        imageStore(o_HZB[0], ivec2(outputPixelPos), vec4(closestDeviceZ));
