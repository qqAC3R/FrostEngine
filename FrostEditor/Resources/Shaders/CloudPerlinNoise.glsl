...
/*
	Fills a 3D texture with PERLIN-WORLEY and WORLEY noises to be used in the volumetric clouds to gather the base shape
...
layout (rgba8, binding = 0) uniform image3D u_CloudNoiseTex;
...
void main()
{
	...
	imageStore(u_CloudNoiseTex, pixel, Stackable3DNoise(pixel));
}