...
/*
	Fills a 3D texture with WORLEY noise to be used in the volumetric clouds as shape eroder

	Credits to:
		https://github.com/NadirRoGue
		https://github.com/fede-vaccaro/TerrainEngine-OpenGL
*/

layout (local_size_x = 4, local_size_y = 4, local_size_z = 4) in;

layout (binding = 0, rgba8) uniform writeonly image3D u_ErroderNoiseTex;

// =====================================================================================
// Code from Sebastien Hillarie 3d noise generator https://github.com/sebh/TileableVolumeNoise
float frequenceMul[6] = float[]( 2.0,8.0,14.0,20.0,26.0,32.0 );
...
void main()
{
	...
	imageStore(u_ErroderNoiseTex, pixel, Stackable3DNoise(pixel));
}
