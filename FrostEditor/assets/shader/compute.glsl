...
layout(binding = 1, set = 0, rgba16f) uniform imageCube u_CubeMap;
...
void main()
{
	...
	imageStore(u_CubeMap, ivec3(gl_GlobalInvocationID.xy, 0), vec4(1.0f));
}
*/
...
layout(binding = 0, set = 0, rgba16f) restrict writeonly uniform imageCube u_CubeMap;
